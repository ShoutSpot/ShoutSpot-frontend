export const EmbedWidgets: React.FC<{setShowWol: React.Dispatch<React.SetStateAction<boolean>>}> = ({setShowWol}) => {
    return (
        <>
            <div className="mt-2 md:mt-5">
                ...
                <div className="pl-4 overflow-hidden transition-all duration-300 ease-in-out max-h-screen">
                    <button className="w-full mt-1 group flex items-center px-3 py-2 text-base leading-5 font-medium text-gray-800 dark:text-white rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none transition ease-in-out duration-150" onClick={() => setShowWol(true)}>
