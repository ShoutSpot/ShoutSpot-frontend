                        ...
                        <div className="pt-20 md:pt-24 pb-12 md:pb-20">
                            <div className="max-w-3xl mx-auto text-center pb-6 md:pb-16">
                                <div className="relative inline-flex flex-col justify-center mb-4 md:mb-12">
                                    <img loading="lazy" className={config.squareLogo ? " mx-auto rounded-md" : "mx-auto rounded-full"} src="https://firebasestorage.googleapis.com/v0/b/testimonialto.appspot.com/o/spaces%2Fabcd%2Flogo?alt=media&token=7f8cd762-b93f-4f8d-8032-6df27e57feb0" style={{ height: "100px" }} alt="" />
                                </div>
                                ...
                                <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
                                    ...
                                    {config.text && <div>
                                        <button className="btn text-white bg-gray-700 hover:bg-gray-800 w-full sm:w-auto sm:ml-4" onClick={() => dispatch(setShowTextModal(true))}> 
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>Send in text
                                        </button>
                                    </div>}
                                </div>
                            </div>
