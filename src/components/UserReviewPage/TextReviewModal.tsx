...
import { setShowTextModal } from "../../features/UserReviewSlice";
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <div className="mt-3">
                                                <div className="rounded-md w-full">
                                                    <textarea required minLength={30} id="message" name="message" rows={5} placeholder={`${formData.starClicked < 3 ? 'What did you dislike? How can we make it better?' : 'What did you like about us?'}`} className="shadow-sm flex-1 form-input block w-full min-w-0 rounded-md text-gray-800 transition duration-150 ease-in-out sm:text-sm sm:leading-5 border-gray-300" value={formData.review} onChange={(e) => setFormDataConfig('review', e.target.value)}></textarea>
                                                </div>
                                            </div>
                                            <ImageComponent />
