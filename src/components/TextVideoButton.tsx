import { TextVideoButtonsInterface } from "../models/models"

export const TextVideoButtons:React.FunctionComponent<TextVideoButtonsInterface> = ({ isTextButtonRequired, isVideoButtonRequired }) => {
    return (
        <div className="mt-6">
